...
//
// Nothing here touches data/btc-prices.json — the tests run on the committed
...
/** Bitcoin's ASSETS entry, the only argument simulate() needs beyond the plan. */
export function btcAsset(engine) {
    return engine.ASSETS.btc;
}
